...
const FormPayment: React.FC<FormClientProps> = ({ user, idBilling, billing }) => {
  ...
  const submitData = async (data: any) => {
    data.billing_id = parseInt(idBilling)
    console.log(data)
    const headers: HeadersInit = new Headers();
    headers.append("Content-Type", "application/json");
    const response: Response = await fetch(`${process.env.BACK_URL}api/billings/paymentpost`, {
      method: 'POST',
      headers,
      body: JSON.stringify(
        data
