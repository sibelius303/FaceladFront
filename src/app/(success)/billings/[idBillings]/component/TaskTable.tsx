...
export const TaskTable: React.FC<FormClientProps> = ({ task }) => {
            ...
            <div className='w-full'>
                ...
                <div className="relative overflow-x-auto">
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500  ">
                        <tbody className=''>
                            {
                                task?.map(el => (<tr key={el.id} className="bg-white border-b py-6 mb-4 rounded-md hover:cursor-pointer hover:bg-slate-100 ">
                                    <td className="px-6 py-4 flex items-center gap-4 text-xs font-medium  whitespace-nowrap">
                                        <div>
