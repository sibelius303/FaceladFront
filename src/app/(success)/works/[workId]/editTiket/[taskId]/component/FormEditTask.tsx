...
const FormEditTask: React.FC<FormClientProps> = ({ workId, user, task, taskId }) => {
  ...
  const submitData = async (data: any) => {
    ...
    const response: Response = await fetch(`${process.env.BACK_URL}api/task/taskput`, {
      method: 'POST',
      headers,
      body: JSON.stringify(
        { data: data, id: taskId, user: user }
      )
    });
